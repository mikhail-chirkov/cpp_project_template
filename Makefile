...
test:
	...
	/home/runner/.conan2/p/cmake0af44960d5e44/p/bin/ctest --force-new-ctest-process $(ARGS)
.PHONY : test
...
edit_cache:
	...
	/home/runner/.conan2/p/cmake0af44960d5e44/p/bin/ccmake -S$(CMAKE_SOURCE_DIR) -B$(CMAKE_BINARY_DIR)
.PHONY : edit_cache
...
rebuild_cache:
	...
	/home/runner/.conan2/p/cmake0af44960d5e44/p/bin/cmake --regenerate-during-build -S$(CMAKE_SOURCE_DIR) -B$(CMAKE_BINARY_DIR)
.PHONY : rebuild_cache
