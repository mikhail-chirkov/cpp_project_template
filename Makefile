...
test:
	...
	/home/runner/.conan2/p/cmakeb507f7f317fb7/p/bin/ctest --force-new-ctest-process $(ARGS)
.PHONY : test
...
edit_cache:
	...
	/home/runner/.conan2/p/cmakeb507f7f317fb7/p/bin/ccmake -S$(CMAKE_SOURCE_DIR) -B$(CMAKE_BINARY_DIR)
.PHONY : edit_cache
...
rebuild_cache:
	...
	/home/runner/.conan2/p/cmakeb507f7f317fb7/p/bin/cmake --regenerate-during-build -S$(CMAKE_SOURCE_DIR) -B$(CMAKE_BINARY_DIR)
.PHONY : rebuild_cache
